...
int make_cir_thread(double new_value, int ele_num, std::vector<ele_unit> &element, std::vector<std::string>& data_cir);

//int make_cir_test(std::vector<ele_unit> &element, std::vector<std::string>& data_cir, ele_cou *cou);
//int make_cir_test2(std::vector<std::vector<ele_unit>> &elements, std::vector<std::string>& data_cir, ele_cou *cou);
//int make_cir_new(double new_value, int ele_row, int ele_col, std::vector<std::vector<ele_unit>> &elements, std::vector<std::string>& data_cir, ele_cou *cou);
/*
