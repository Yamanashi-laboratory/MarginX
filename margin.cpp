...
/*
// インダクタンスのマージン測定 
int margin_L(int n, ele_unit *p, vector<int> &elej, vector<judge> &jud, board *top, vector<string> &data_cir, ele_cou *cou, int cols, int judgenum){
    int check = 0;
    double value_h, HIGH, LOW, percent_HIGH, percent_LOW, median;
    
    stringstream commandname, delete_cir, delete_out, out_det, out_fig, out_csv;
    commandname << "josim margin" << getpid() << ".cir > /dev/null";
    delete_cir << "rm -f margin" << getpid() << ".cir";
    delete_out << "rm -f MARGIN" << getpid() << ".CSV";
    ...
    while(check < 4){
        HIGH = HIGH + pow(10 , -check);
        make_cir(n, HIGH, p, data_cir, cou);
        if(system((commandname.str()).c_str()) == -1){
            printf("error:1\n");
        }
        else if(judge_operation(elej, jud) == 0){
    ...
    LOW = element[ele_num].value;
    while(check < 4){
        LOW = LOW - pow(10 , -check);
        if(LOW < 0){
            LOW = LOW + pow(10 ,-check);
            check += 1;
        }
        make_cir(n, LOW, p, data_cir, cou);
        if(system((commandname.str()).c_str()) == -1){
            printf("error:1\n");
        }
        if(judge_operation(elej, jud) == 0){
    ...
    out_det << setw(6) << element[ele_num].element << " " << fixed  << right << setw(6) << setprecision(3) << element[ele_num].value  << " pH " << " Lower: "  << setprecision(3) << setw(6) << LOW << "   Upper: "
                << setw(6) << setprecision(3)  << HIGH << "   Median: " << setw(6) << setprecision(3)  << median << "  "  << setprecision(2) << setw(7) << percent_LOW << " % ~ "  << setprecision(2) << setw(6) << percent_HIGH << " %";
    
    strcpy(top->msg[n], (out_det.str()).c_str());
    ...
    out_fig << setw(6) << element[ele_num].element << "  :  " << fixed  << right << setprecision(2) << setw(6) << -hush_num[0] << " % ["
                << setw(25) << hush[0] << "|" << left << setw(25) << hush[1] << "]" << right << setprecision(2) << setw(6) << hush_num[1] << " %";
    strcpy(top->fig[n], (out_fig.str()).c_str());

    out_csv << setw(5) << element[ele_num].element << ","<< setw(6) << setprecision(3) << percent_LOW << "," << setw(6) << setprecision(3) << percent_HIGH;
    strcpy(top->fig_csv[n],  (out_csv.str()).c_str());
...
// 結合係数のマージン測定   
int margin_K(int n, ele_unit *p,vector<int> &elej, vector<judge> &jud, board *top, vector<string> &data_cir, ele_cou *cou, int cols, int judgenum){
    int check = 0;
    double value_h, value_l, HIGH, LOW, percent_HIGH, percent_LOW, median;
 ...
 //結合係数が負の場合
    ...
    out_det << setw(6) << element[ele_num].element << " " << fixed  << right << setw(6) << setprecision(3) << element[ele_num].value  << "    " << " Lower: "  << setprecision(3) << setw(6) << LOW << "   Upper: "
                << setw(6) << setprecision(3)  << HIGH << "   Median: " << setw(6) << setprecision(3)  << median << "  "  << setprecision(2) << setw(7) << percent_LOW << " % ~ "  << setprecision(2) << setw(6) << percent_HIGH << " %";

    strcpy(top->msg[cou->count_L + n], (out_det.str()).c_str());
    ...
    out_fig << setw(6) << element[ele_num].element << "  :  " << fixed  << right << setprecision(2) << setw(6) << -hush_num[0] << " % ["
                << setw(25) << hush[0] << "|" << left << setw(25) << hush[1] << "]" << right << setprecision(2) << setw(6) << hush_num[1] << " %";
    strcpy(top->fig[cou->count_L + n], (out_fig.str()).c_str());

    out_csv << setw(5) << element[ele_num].element << ","<< setw(6) << setprecision(3) << percent_LOW << "," << setw(6) << setprecision(3) << percent_HIGH;
    strcpy(top->fig_csv[cou->count_L + n],  (out_csv.str()).c_str());
...
// ジョセフソン接合のマージン測定 
int margin_B(int n, ele_unit *p,vector<int> &elej, vector<judge> &jud, board *top, vector<string> &data_cir, ele_cou *cou, int cols, int judgenum){
    int check = 0;
    double value_h, HIGH, LOW, percent_HIGH, percent_LOW, median;
    ...
    out_det << setw(6) << element[ele_num].element << " " << fixed  << right << setw(6) << setprecision(3) << element[ele_num].value  << "    " << " Lower: "  << setprecision(3) << setw(6) << LOW << "   Upper: "
                << setw(6) << setprecision(3)  << HIGH << "   Median: " << setw(6) << setprecision(3)  << median << "  "  << setprecision(2) << setw(7) << percent_LOW << " % ~ "  << setprecision(2) << setw(6) << percent_HIGH << " %";
    strcpy(top->msg[cou->sum_B + n], (out_det.str()).c_str());
    //マージン図を作成
    vector<string> hush(2);
    vector<double> hush_num{-percent_LOW, percent_HIGH};
    for( int j = 0 ; j < 2 ; j++ ){
    ...
    out_fig << setw(6) << element[ele_num].element << "  :  " << fixed  << right << setprecision(2) << setw(6) << -hush_num[0] << " % ["
                << setw(25) << hush[0] << "|" << left << setw(25) << hush[1] << "]" << right << setprecision(2) << setw(6) << hush_num[1] << " %";
    strcpy(top->fig[cou->sum_B + n], (out_fig.str()).c_str());
    //csvファイルに書き込む内容を作成
    out_csv << setw(5) << element[ele_num].element << ","<< setw(6) << setprecision(3) << percent_LOW << "," << setw(6) << setprecision(3) << percent_HIGH;
    strcpy(top->fig_csv[cou->sum_B + n],  (out_csv.str()).c_str());
...
// JJインダクタンスのマージン測定 
int margin_BI(int n, ele_unit *p, vector<int> &elej, vector<judge> &jud, board *top,vector<string> &data_cir, ele_cou *cou, int cols, int judgenum){
    int check = 0;
    double value_h, HIGH, LOW, percent_HIGH, percent_LOW, median;
    ...
    strcpy(top->msg[cou->sum_BI + n], (out_det.str()).c_str());
    ...
    out_fig << setw(6) << element[ele_num].element << "  :  " << fixed  << right << setprecision(2) << setw(6) << -hush_num[0] << " % ["
                << setw(25) << hush[0] << "|" << left << setw(25) << hush[1] << "]" << right << setprecision(2) << setw(6) << hush_num[1] << " %";
    strcpy(top->fig[cou->sum_BI + n], (out_fig.str()).c_str());

    out_csv << setw(5) << element[ele_num].element << ","<< setw(6) << setprecision(3) << percent_LOW << "," << setw(6) << setprecision(3) << percent_HIGH;
    strcpy(top->fig_csv[cou->sum_BI + n],  (out_csv.str()).c_str());
...
// π接合のマージン測定 
int margin_PI(int n, ele_unit *p, vector<int> &elej, vector<judge> &jud, board *top, vector<string> &data_cir, ele_cou *cou, int cols, int judgenum){
    int check = 0;
    double value_h, HIGH, LOW, percent_HIGH, percent_LOW, median;
    ...
    strcpy(top->msg[cou->sum_PI + n], (out_det.str()).c_str());
    ...
    out_fig << setw(6) << element[ele_num].element << "  :  " << fixed  << right << setprecision(2) << setw(6) << -hush_num[0] << " % ["
                << setw(25) << hush[0] << "|" << left << setw(25) << hush[1] << "]" << right << setprecision(2) << setw(6) << hush_num[1] << " %";
    strcpy(top->fig[cou->sum_PI + n], (out_fig.str()).c_str());

    out_csv << setw(5) << element[ele_num].element << ","<< setw(6) << setprecision(3) << percent_LOW << "," << setw(6) << setprecision(3) << percent_HIGH;
    strcpy(top->fig_csv[cou->sum_PI + n],  (out_csv.str()).c_str());
...
// 抵抗のマージン測定 
int margin_R(int n, ele_unit *p,vector<int> &elej, vector<judge> &jud, board *top, vector<string> &data_cir, ele_cou *cou, int cols, int judgenum){
    int check = 0;
    double value_h, HIGH, LOW, percent_HIGH, percent_LOW, median;
    ...
    out_det << setw(6) << element[ele_num].element << " " << fixed  << right << setw(6) << setprecision(3) << element[ele_num].value  << " ohm" << " Lower: "  << setprecision(3) << setw(6) << LOW << "   Upper: "
                << setw(6) << setprecision(3)  << HIGH << "   Median: " << setw(6) << setprecision(3)  << median << "  "  << setprecision(2) << setw(7) << percent_LOW << " % ~ "  << setprecision(2) << setw(6) << percent_HIGH << " %";

    strcpy(top->msg[cou->sum_R+ n], (out_det.str()).c_str());
    ...
    out_fig << setw(6) << element[ele_num].element << "  :  " << fixed  << right << setprecision(2) << setw(6) << -hush_num[0] << " % ["
                << setw(25) << hush[0] << "|" << left << setw(25) << hush[1] << "]" << right << setprecision(2) << setw(6) << hush_num[1] << " %";
    strcpy(top->fig[cou->sum_R + n], (out_fig.str()).c_str());

    out_csv << setw(5) << element[ele_num].element << ","<< setw(6) << setprecision(3) << percent_LOW << "," << setw(6) << setprecision(3) << percent_HIGH;
    strcpy(top->fig_csv[cou->sum_R + n],  (out_csv.str()).c_str());
...
// バイアス電圧マージン測定 
int margin_V(int n, ele_unit *p, vector<int> &elej, vector<judge> &jud, board *top, vector<string> &data_cir, ele_cou *cou, int cols, int judgenum){
    int check = 0;
    double value_h, HIGH, LOW, percent_HIGH, percent_LOW, median;
    ...
    out_det << setw(6) << element[ele_num].element << " " << fixed  << right << setw(6) << setprecision(3) << element[ele_num].value  << " mV " << " Lower: "  << setprecision(3) << setw(6) << LOW << "   Upper: "
                << setw(6) << setprecision(3)  << HIGH << "   Median: " << setw(6) << setprecision(3)  << median << "  "  << setprecision(2) << setw(7) << percent_LOW << " % ~ "  << setprecision(2) << setw(6) << percent_HIGH << " %";

    strcpy(top->msg[cou->sum_V + n], (out_det.str()).c_str());
    ...
    out_fig << setw(6) << element[ele_num].element << "  :  " << fixed  << right << setprecision(2) << setw(6) << -hush_num[0] << " % ["
                << setw(25) << hush[0] << "|" << left << setw(25) << hush[1] << "]" << right << setprecision(2) << setw(6) << hush_num[1] << " %";
    strcpy(top->fig[cou->sum_V + n], (out_fig.str()).c_str());

    out_csv << setw(5) << element[ele_num].element << ","<< setw(6) << setprecision(3) << percent_LOW << "," << setw(6) << setprecision(3) << percent_HIGH;
    strcpy(top->fig_csv[cou->sum_V + n],  (out_csv.str()).c_str());
...
// バイアス電流マージン測定
int margin_I(int n, ele_unit *p, vector<int> &elej, vector<judge> &jud, board *top, vector<string> &data_cir,  ele_cou *cou, int cols, int judgenum){
    int check = 0;
    double value_h, HIGH, LOW, percent_HIGH, percent_LOW, median;
    ...
    out_det << setw(6) << element[ele_num].element << " " << fixed  << right << setw(6) << setprecision(3) << element[ele_num].value  << " mA " << " Lower: "  << setprecision(3) << setw(6) << LOW << "   Upper: "
                << setw(6) << setprecision(3)  << HIGH << "   Median: " << setw(6) << setprecision(3)  << median << "  "  << setprecision(2) << setw(7) << percent_LOW << " % ~ "  << setprecision(2) << setw(6) << percent_HIGH << " %";

    strcpy(top->msg[cou->sum_I + n], (out_det.str()).c_str());
    ...
    out_fig << setw(6) << element[ele_num].element << "  :  " << fixed  << right << setprecision(2) << setw(6) << -hush_num[0] << " % ["
                << setw(25) << hush[0] << "|" << left << setw(25) << hush[1] << "]" << right << setprecision(2) << setw(6) << hush_num[1] << " %";
    strcpy(top->fig[cou->sum_I + n], (out_fig.str()).c_str());

    out_csv << setw(5) << element[ele_num].element << ","<< setw(6) << setprecision(3) << percent_LOW << "," << setw(6) << setprecision(3) << percent_HIGH;
    strcpy(top->fig_csv[cou->sum_I + n],  (out_csv.str()).c_str());
