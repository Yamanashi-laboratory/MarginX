...
void Margin_jsim_seq(vector<ele_unit> &element, vector<vector<judge>> &jud, vector<string> &data_cir, vector<string> &arg_arr, int menu){
    if(menu == 0 || menu == 2){
    ...
    for(int i = 0; i < element.size(); i++){
        margin_ele_jsim(i,element,  jud, top, data_cir);
        string str = "";
