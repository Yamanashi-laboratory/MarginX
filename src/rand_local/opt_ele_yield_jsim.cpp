...
void opt_ele_yield_jsim(vector<ele_unit> &element, vector<string> &data_cir, vector<vector<judge>> &jud, opt_num *opt, double global, double local_nd, vector<double> &global_rand){
    ...
    commandname << "jsim OPTIMIZE" << getpid() << ".cir > /dev/null"; 
